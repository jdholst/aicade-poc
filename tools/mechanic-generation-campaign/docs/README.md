...
- [Campaign loops](campaign-loops.md): bounded multi-campaign proof, knowledge gathering and use, fix checkpoints, revision resets, budget extensions, and stopped-session lifecycle.
