...
const topDownPhaserRuntimeSource = `
(function () {
  ...
  function collectObjective(scene) {
    score += 1;
  ...
  function createScene() {
    return {
      ...
      create() {
        ...
        this.physics.world.setBounds(32, 32, viewport.width - 64, viewport.height - 64);
        ...
        this.physics.add.overlap(player, objective, () => collectObjective(this));
...
export const topDownPhaserTemplate: HandAuthoredPhaserTemplate = {
  ...
  runtimeSource: topDownPhaserRuntimeSource,
};
